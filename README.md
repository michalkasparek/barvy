...
```['#5E2D3A', '#445B78', '#70871E', '#D6534B', '#DB842F', '#81A9D5', '#E09DA3', '#EED801', '#FFFFE4']```

![jak_s_tim_pohnu_102_sorted](palety/jak_s_tim_pohnu_102_sorted.png)
...
```['#1D5939', '#812E59', '#2B61A2', '#BC3A5D', '#688D34', '#D67BA5', '#8EB0CF', '#D1BC18', '#C7CE51', '#D8C6A3', '#ECEADC']```
...
```['#CA4955', '#316DC1', '#E4D104', '#1B4D21', '#A9752F', '#D07863', '#9ABFDD', '#7A9648', '#F7F5DC']```

![rychle_sipy_rychlonozka_krasobruslar](palety/rychle_sipy_rychlonozka_krasobruslar.png)

```['#1B4D21', '#316DC1', '#CA4955', '#A9752F', '#7A9648', '#D07863', '#9ABFDD', '#E4D104', '#F7F5DC']```
...
```['#AF4752', '#01A1BC', '#9CB872', '#F89E43', '#E6B095', '#B3CBD2', '#A1D3D9', '#F1AFC5', '#FBE597', '#FCFCFD']```
...
```['#43335B', '#DE4D49', '#8F7B9B', '#BA8A72', '#F27C55', '#c1c1c1', '#F0F2ED']```
...
```['#C66774', '#619AC1', '#C37583', '#8C8CB0', '#D0A77E', '#BCBE73', '#D6C1BF', '#C9D6D8', '#EDDC73', '#E7E5DA']```
...
```['#42454A', '#D15A41', '#788A98', '#D98D72', '#A6AC83', '#D5B574', '#E0AC93', '#E8DECA']```
...
```['#5d80c1', '#ae7645', '#8eba21', '#f77961', '#e975b2', '#89a4df', '#fda24d', '#fdc578', '#ffd71b', '#FEFEFE']```
...
```['#b45058', '#d94b60', '#cf556b', '#687fa9', '#a39889', '#95a8bf', '#84c0e4', '#b7d5a9', '#e3d83b', '#FEFEFE']```

![s_malirem_5_sorted](palety/s_malirem_5_sorted.png)
...
```['#7B5A57', '#8A7137', '#9F7E70', '#7C8CCE', '#6F9BC6', '#9E9F91', '#E79F74', '#B0CAE6', '#F0D27B', '#E0DAB5', '#FEFEFE']```
...
```['#8B4D36', '#60707C', '#8B884F', '#A97F4C', '#93948C', '#BDAC60', '#D7CDC0']```
...
```['#242D60', '#AB7629', '#4A682B', '#191F37', '#B51310', '#131A14', '#B86862', '#7F422B', '#D0902B', '#0F0F0D', '#565147', '#386693', '#B1ADA9']```
...
```['#810112', '#B8A218', '#021D5C', '#6F8DAC', '#010242', '#010116', '#29544B', '#82998A', '#C5C88E', '#CBD4D3']```

![narodni_soutez_velkych_dechovych_orchestru](palety/narodni_soutez_velkych_dechovych_orchestru.png)

```['#010116', '#010242', '#021D5C', '#810112', '#29544B', '#6F8DAC', '#82998A', '#B8A218', '#C5C88E', '#CBD4D3']```
...
![josef_lada_detem_leto](palety/josef_lada_detem_leto.png)

```['#372C23', '#71351E', '#CF5230', '#738F43', '#AD7B3B', '#CB7530', '#98B5A1', '#CDBB5E', '#C0C162', '#DDDBB4']```

![josef_lada_detem_leto_sorted](palety/josef_lada_detem_leto_sorted.png)
...
```['#658B88', '#363130', '#B44350', '#FAE204', '#86A82A', '#FEFFFA']```

![pet_olympijskych_kruhu_6](palety/pet_olympijskych_kruhu_6.png)

```['#363130', '#B44350', '#658B88', '#86A82A', '#FAE204', '#FEFFFA']```
...
```['#EB78BB', '#548EC1', '#FEF325', '#3C3833', '#FEFFFA']```

![pet_olympijskych_kruhu_227](palety/pet_olympijskych_kruhu_227.png)

```['#3C3833', '#548EC1', '#EB78BB', '#FEF325', '#FEFFFA']```

![pet_olympijskych_kruhu_227_sorted](palety/pet_olympijskych_kruhu_227_sorted.png)

## pet_olympijskych_kruhu_417

originál: [Pět olympijských kruhů](https://www.digitalniknihovna.cz/mzk/view/uuid:fd622800-21c1-11e3-a5bb-005056827e52?page=uuid:a2ec29e0-35f6-11e3-b62e-005056825209), kudos: Jan Schmid

```['#55891E', '#5791BF', '#E27648', '#FDE70E', '#3C3833', '#FEFFFA']```

![pet_olympijskych_kruhu_417](palety/pet_olympijskych_kruhu_417.png)

```['#3C3833', '#55891E', '#5791BF', '#E27648', '#FDE70E', '#FEFFFA']```

![pet_olympijskych_kruhu_417_sorted](palety/pet_olympijskych_kruhu_417_sorted.png)
...
```['#405045', '#824a42', '#83563f', '#608793', '#98807f', '#828f9b', '#93918a', '#a0a465', '#beb47d', '#DCDDD6']```
...
```['#596C74', '#b97e67', '#979d85', '#ab9b8e', '#c1b07e', '#cdbfa6']```
...
```['#C92546', '#D7A0AC', '#96ADB2', '#A3BCBE', '#131410', '#DEDEDF']```

![vitej_zpet_karle](palety/vitej_zpet_karle.png)

```['#131410', '#C92546', '#96ADB2', '#D7A0AC', '#A3BCBE', '#DEDEDF']```
